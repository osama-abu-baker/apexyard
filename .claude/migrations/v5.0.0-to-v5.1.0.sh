#!/bin/bash
# v5.0.0 → v5.1.0 migration: PLACEHOLDER (no-op)
#
# v5.1.0 shipped no per-adopter migration — no gitignored region moved, no
...
info "migration v5.0.0→v5.1.0: placeholder (no adopter-facing migration for this release)."
exit 0
