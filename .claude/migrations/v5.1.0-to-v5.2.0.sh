#!/bin/bash
# v5.1.0 → v5.2.0 migration: PLACEHOLDER (no-op)
#
# v5.2.0 shipped no per-adopter migration — no gitignored region moved, no
...
info "migration v5.1.0→v5.2.0: placeholder (no adopter-facing migration for this release)."
exit 0
